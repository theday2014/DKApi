...
public class UTF8StringHttpMessageConverter extends AbstractHttpMessageConverter<String> {
    ...
    private final List<Charset> availableCharset;
    ...
    public UTF8StringHttpMessageConverter(Charset defaultCharset) {
        ...
        this.availableCharset = new ArrayList<Charset>(Charset.availableCharsets().values());
    }
    ...
    protected List<Charset> getAcceptedCharset() {
